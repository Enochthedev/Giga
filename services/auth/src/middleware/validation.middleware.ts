...
export const registerSchema = z
  .object({
    ...
    roles: z
      .array(z.enum(['CUSTOMER', 'VENDOR', 'DRIVER', 'HOST', 'ADVERTISER']))
      .default(['CUSTOMER'])
...
export const resendPhoneVerificationSchema = z
  .object({
    phone: securePhoneSchema,
  })
  .strict();
...
export const updateProfileVerificationSchema = z
  .object({
    userId: z
      .string()
...
export const updateProfileRatingSchema = z
  .object({
    userId: z
      .string()
      .min(1, 'User ID is required')
...
export const bulkUpdateUsersSchema = z
  .object({
    userIds: z
...
export const assignUserRoleSchema = z
  .object({
    role: z.enum(
      ['CUSTOMER', 'VENDOR', 'DRIVER', 'HOST', 'ADVERTISER', 'ADMIN'],
      {
        errorMap: () => ({ message: 'Invalid role specified' }),
      }
    ),
...
export const removeUserRoleSchema = z
  .object({
